...
export const networkConfigs: Record<string, BaseNetworkConfig> = {
  [ChainId.goerli]: {
    ...
    // usdMarket: true,
    isTestnet: true,
    networkLogoPath: '/apps/aave/icons/networks/ethereum.svg',
  },
  [ChainId.mainnet]: {
    name: 'Ethereum',
  ...
  [ChainId.polygon]: {
    ...
    networkLogoPath: '/apps/aave/icons/networks/polygon.svg',
    bridge: {
      icon: '/apps/aave/icons/bridge/polygon.svg',
  ...
  [ChainId.fuji]: {
    ...
    // usdMarket: true,
    isTestnet: true,
    networkLogoPath: '/apps/aave/icons/networks/avalanche.svg',
    bridge: {
      icon: '/apps/aave/icons/bridge/avalanche.svg',
  ...
  [ChainId.arbitrum_goerli]: {
    ...
    // usdMarket: true,
    isTestnet: true,
    networkLogoPath: '/apps/aave/icons/networks/arbitrum.svg',
    bridge: {
      icon: '/apps/aave/icons/bridge/arbitrum.svg',
  ...
  [ChainId.harmony]: {
    ...
    // rpcOnly: true,
    // usdMarket: true,
    networkLogoPath: '/apps/aave/icons/networks/harmony.svg',
    bridge: {
      icon: '/apps/aave/icons/bridge/harmony.svg',
      name: 'Harmony Bridge',
  ...
  [ChainId.optimism]: {
    ...
    // rpcOnly: true,
    // usdMarket: true,
    networkLogoPath: '/apps/aave/icons/networks/optimism.svg',
    bridge: {
      icon: '/apps/aave/icons/bridge/optimism.svg',
  ...
  [ChainId.fantom]: {
    ...
    // rpcOnly: true,
    // usdMarket: true,
    networkLogoPath: '/apps/aave/icons/networks/fantom.svg',
    bridge: {
      icon: '/apps/aave/icons/bridge/fantom.svg',
      name: 'Fantom Bridge',
